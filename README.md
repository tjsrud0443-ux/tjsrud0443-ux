...
그룹웨어 프로젝트 **Orbit**에서는 조직도, 전자결재, 실시간 알림, 프로젝트 칸반보드,  
...
- RAG 기반 AI 챗봇, 실시간 알림, 전자결재, 조직도, 프로젝트 칸반보드 등 업무 시스템 기능 구현 경험
...
> 조직도, 전자결재, 프로젝트 관리/칸반보드, 실시간 알림, 회사 정보 등록/수정과 Hybrid RAG 기반 AI 챗봇을 포함한 협업 플랫폼

### 📖 프로젝트 개요

Orbit은 조직도, 전자결재, 프로젝트 관리, 일정, 근태, 실시간 알림, 관리자 기능,  
...
- 실시간 알림, 권한 제어, 전자결재, 칸반보드처럼 실제 업무 시스템에서 필요한 기능 흐름을 이해했습니다.
...
조직도, 전자결재, 실시간 알림, 프로젝트 칸반보드, AI 챗봇 등  
...
- 📝 Notion: [Notion Portfolio](https://app.notion.com/p/Portfolio-1ebc59b1c172828a8ef7812704f611fa?source=copy_link)
